...
home = "/home/tiraka/Harjoitustyot_public/hw2_clavis/"
julkinen = "./"
...
def main():    
	...
	tests_in = [
		...
		julkinen+"test_simple_add_del.in",
		julkinen+"test_100.in",
		julkinen+"test_duplicates.in",
		julkinen+"test_delete.in",
		julkinen+"test_print.in"
	]

	tests_out =[
		julkinen+"test_public.out",
		julkinen+"test_simple_add_del.out",
		julkinen+"test_100.out",
		julkinen+"test_duplicates.out",
		julkinen+"test_delete.out",
		julkinen+"test_print.out"
	]
